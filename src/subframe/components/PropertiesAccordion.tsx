...
/*
 * Documentation:
 * Properties Accordion — https://app.subframe.com/library?component=Properties+Accordion_90a4daf8-09e8-4402-b7b1-442a7b019644
...
>(function PropertiesAccordionRoot(
  ...
  return (
    ...
    >
      ...
      >
        {children ? (
          <div className="flex h-full w-full grow shrink-0 basis-0 flex-col items-start gap-2 pr-4 pb-4 pl-4">
            {children}
          </div>
        ) : null}
      </Accordion>
